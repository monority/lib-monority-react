...
export const showcaseSections = [
    {
        ...
        description: 'Une carte par primitive pour parcourir rapidement la librairie.',
    },
    {
        id: 'typography',
        label: 'Typography',
    ...
    },
    {
        ...
        description: 'Actions primaires, secondaires et iconographiques.',
    },
    {
        id: 'forms',
        label: 'Forms',
