        ...
        <div className="docs-page">
            <header className="docs-hero">
                ...
                <p className="docs-description">
                    Set up Monority UI in your project, load the shared styles, and start composing
                    product-ready screens with the component system.
                </p>
            </header>
...
import '@monority/ui/styles.css'`}</DocsCodeBlock>
                ...
                <div className="docs-step">
                    ...
                    <div className="docs-step__content">
                        ...
                        <p>
                            Import from the main barrel for convenience, or use sub-path imports
...
import { Modal } from '@monority/ui/modal'`}</DocsCodeBlock>
            ...
            <section className="docs-section">
                ...
                <ul className="docs-list">
                    ...
                    <li>
                        Explore layout recipes next for page shells, content bands, and spacing
                        patterns
                    </li>
                </ul>
            </section>
