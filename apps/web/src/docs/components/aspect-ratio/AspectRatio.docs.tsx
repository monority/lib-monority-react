...
const docData: DocPageData = {
  title: 'AspectRatio',
  description: 'Maintains a fixed aspect ratio for child content using the CSS padding-bottom trick.',
  ...
  props: [
    { name: 'ratio', type: 'number', defaultValue: '16 / 9', description: 'Aspect ratio as width/height.' }
  ],
  cssHooks: [
    '.mr-aspect-ratio',
    '.mr-aspect-ratio__content',
  ],
  tokens: [],
  a11y: [
