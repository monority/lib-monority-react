...
const docData: DocPageData = {
  title: 'Select',
  description: "A dropdown menu that allows users to select one option from a list. Supports label, hint, error, sizes, and disabled state.",
  ...
  props: [
    ...
    { name: 'tone', type: `'neutral' | 'accent' | 'danger'`, defaultValue: "'neutral'", description: "Visual tone" },
  ...
  cssHooks: [
    '.mr-select', '.mr-select--sm', '.mr-select--md', '.mr-select--lg',
    '.mr-select--neutral', '.mr-select--accent', '.mr-select--danger',
    '[data-size]', '[data-disabled]', '[data-invalid]', '[data-tone]',
  ],
  tokens: [
    '--mr-border-subtle', '--mr-bg-control', '--mr-fg-base', '--mr-fg-muted',
    '--mr-input-height', '--mr-radius-md', '--mr-text-sm',
    '--mr-accent', '--mr-danger',
  ],
  a11y: [
