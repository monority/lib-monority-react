...
const docData: DocPageData = {
  title: 'RadioGroup',
  description: "Radio button group with label, hint, error, descriptions, and accessible keyboard navigation.",
...
<RadioGroup label="Size" items={items} />`,
  ...
  props: [
    ...
    { name: 'items', type: `RadioItem[]`, defaultValue: "[]", description: "Radio options. Each item: { value, label, description?, disabled? }." },
    ...
    { name: 'onChange', type: `(value: string) => void`, defaultValue: "-", description: "Change callback receiving the selected value." },
