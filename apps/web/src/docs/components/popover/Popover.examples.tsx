import { Button, Input, Popover } from '@monority/ui'
  ...
  return (
    <Popover trigger={<Button>Inspect token</Button>}>
      <div style={{ display: 'grid', gap: '0.5rem' }}>
        ...
        <div style={{ color: 'var(--mr-fg-muted)', fontSize: 'var(--mr-text-sm)', lineHeight: 1.5 }}>
  ...
  return (
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
      <Popover trigger={<Button>Start</Button>} align="start">
        <div style={{ color: 'var(--mr-fg-muted)', fontSize: 'var(--mr-text-sm)' }}>Aligned to start edge.</div>
      </Popover>
      <Popover trigger={<Button>Center</Button>} align="center">
        <div style={{ color: 'var(--mr-fg-muted)', fontSize: 'var(--mr-text-sm)' }}>Centered for compact callouts.</div>
      </Popover>
      <Popover trigger={<Button>End</Button>} align="end">
        <div style={{ color: 'var(--mr-fg-muted)', fontSize: 'var(--mr-text-sm)' }}>Aligned to end edge.</div>
      </Popover>
    </div>
  )
}
