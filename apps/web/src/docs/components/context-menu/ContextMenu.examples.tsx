...
export function ContextMenuBasicExample() {
  ...
  return <ContextMenu trigger={<TriggerSurface label="Right-click this canvas" />} items={items} />
}
...
export function ContextMenuWithDangerExample() {
  ...
  return <ContextMenu trigger={<TriggerSurface label="Right-click this workspace" />} items={items} />
}
...
export function ContextMenuWithSeparatorExample() {
  ...
  return <ContextMenu trigger={<TriggerSurface label="Right-click this text block" />} items={items} />
}
