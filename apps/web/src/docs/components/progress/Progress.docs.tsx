...
const docData: DocPageData = {
  ...
  props: [
    ...
    { name: 'mode', type: `'determinate' | 'indeterminate'`, defaultValue: "'determinate'", description: 'Display mode. Indeterminate shows an animated bar.' },
    { name: 'onChange', type: `(value: number) => void`, defaultValue: '-', description: 'Click handler on the track for interactive slider mode.' },
