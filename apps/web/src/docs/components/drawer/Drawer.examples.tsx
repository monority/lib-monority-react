        ...
        <>
            ...
            <Drawer open={open} title="Deployment details" onClose={() => setOpen(false)}>
                <div style={{ display: 'grid', gap: '0.875rem', lineHeight: 1.6 }}>
                    <p style={{ margin: 0 }}>
                        Use a drawer when the user should stay anchored to the current page while
                        inspecting or editing adjacent information.
                    </p>
                    <p style={{ margin: 0 }}>
        ...
        <>
            ...
            >
                <p style={{ margin: 0, lineHeight: 1.6 }}>
                    Left-side drawers are useful for supplemental navigation, saved views, and
            ...
            >
                <p style={{ margin: 0, lineHeight: 1.6 }}>
                    Right-side drawers are ideal for metadata, audit trails, or property editing
                    next to the primary canvas.
                </p>
            </Drawer>
        </>
    )
        ...
        <>
            ...
            <Drawer open={open} title="Publish settings" onClose={() => setOpen(false)}>
                <div style={{ display: 'grid', gap: '1rem' }}>
                    ...
                    <label style={{ display: 'grid', gap: '0.375rem' }}>
                        <span style={{ fontSize: '0.875rem', fontWeight: 560 }}>
                            Announcement title
                        </span>
