...
export const docsComponentRegistry: DocsComponentRegistryItem[] = [
  ...
  { category: 'forms', label: 'NumberInput', path: '/docs/number-input', slug: 'number-input', status: 'draft' },
  { category: 'forms', label: 'PasswordInput', path: '/docs/password-input', slug: 'password-input', status: 'draft' },
  { category: 'forms', label: 'RadioGroup', path: '/docs/radio-group', slug: 'radio-group', status: 'draft' },
  { category: 'forms', label: 'SearchInput', path: '/docs/search-input', slug: 'search-input', status: 'draft' },
