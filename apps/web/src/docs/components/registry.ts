...
export const docsComponentRegistry: DocsComponentRegistryItem[] = [
    ...
    {
        category: 'feedback',
        label: 'AsyncStateNotice',
        path: '/docs/async-state-notice',
        slug: 'async-state-notice',
        status: 'draft',
    },
