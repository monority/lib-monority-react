...
const releaseItems = [
  {
    ...
    content: (
      <p>
        Surface, border, and emphasis tokens were tightened so docs, product
        shells, and overlays read like one family instead of separate demos.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Start with shells, then shared controls, then content surfaces. That
        order keeps visual drift low while preserving local component APIs.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        No breaking keyboard changes. The update mostly improves focus contrast,
        spacing rhythm, and panel readability.
      </p>
    ),
  },
]
    ...
    <Accordion
      items={[
        ...
        },
        {
          ...
          content: (
            <p>
              Shell, tabs, menus, and wayfinding components tuned for scanning
              and repeat use.
            </p>
          ),
        },
    ...
    <Accordion
      ...
      items={[
        ...
        },
        {
          value: 'guides',
          title: 'Guides',
          content: <p>Opinionated walkthroughs for forms, shells, and content-heavy screens.</p>,
        },
        {
          value: 'examples',
          title: 'Examples',
      ...
      items={[
        {
          ...
          content: (
            <p>
              The component manages open state by default, but you can fully
              control expanded items when docs or product logic require it.
            </p>
          ),
        },
        {
          ...
          content: (
            <p>
              Use concise explanations, nested metadata, or short follow-up
              actions. Long-form reading usually belongs in a section instead.
            </p>
          ),
        },
      ]}
