import { ScrollArea } from '@monority/ui'
...
export function ScrollAreaBasicExample() {
  return (
    <ScrollArea style={{ maxHeight: '200px', border: '1px solid var(--mr-border-subtle)', borderRadius: 'var(--mr-radius-md)', padding: '0.5rem' }}>
      {longText}
    </ScrollArea>
  )
}
...
export function ScrollAreaHorizontalExample() {
  return (
    <ScrollArea orientation="horizontal" style={{ border: '1px solid var(--mr-border-subtle)', borderRadius: 'var(--mr-radius-md)', padding: '0.5rem' }}>
      {wideContent}
    </ScrollArea>
  )
}
...
export function ScrollAreaBothExample() {
  return (
    <ScrollArea orientation="both" style={{ maxHeight: '200px', border: '1px solid var(--mr-border-subtle)', borderRadius: 'var(--mr-radius-md)' }}>
      {bigTable}
    </ScrollArea>
  )
}
...
export function ScrollAreaHideScrollbarExample() {
  return (
    <ScrollArea hideScrollbar style={{ maxHeight: '200px', border: '1px solid var(--mr-border-subtle)', borderRadius: 'var(--mr-radius-md)', padding: '0.5rem' }}>
      {longText}
    </ScrollArea>
  )
}
