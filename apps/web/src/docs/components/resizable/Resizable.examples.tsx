import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from '@monority/ui/resizable'
        ...
        <div style={{ height: '200px', border: '1px solid var(--mr-border-subtle)' }}>
            <ResizablePanelGroup direction="horizontal">
                ...
                <ResizablePanel defaultSize={70}>
                    <div style={{ padding: '1rem' }}>Right panel (70%)</div>
                </ResizablePanel>
            </ResizablePanelGroup>
        </div>
    )
        ...
        <div style={{ height: '300px', border: '1px solid var(--mr-border-subtle)' }}>
            <ResizablePanelGroup direction="vertical">
                ...
                <ResizablePanel defaultSize={60}>
                    <div style={{ padding: '1rem' }}>Bottom panel (60%)</div>
                </ResizablePanel>
            </ResizablePanelGroup>
        </div>
    )
        ...
        <div style={{ height: '200px', border: '1px solid var(--mr-border-subtle)' }}>
            <ResizablePanelGroup>
                ...
                <ResizablePanel defaultSize={50} minSize={20}>
                    <div style={{ padding: '1rem' }}>Main content (50%)</div>
                </ResizablePanel>
                <ResizableHandle withHandle />
                <ResizablePanel defaultSize={25} minSize={15}>
                    <div style={{ padding: '1rem', background: 'var(--mr-bg-control)' }}>
