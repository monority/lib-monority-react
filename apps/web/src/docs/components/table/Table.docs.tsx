...
import { TableBasicExample, TableWithDataExample, TableEmptyExample } from './Table.examples'
...
<Table columns={columns} rows={[]} />`,
    ...
    cssHooks: ['.mr-table', '.mr-table__head', '.mr-table__th', '.mr-table__td', '.mr-table__tr'],
    tokens: [
        '--mr-border-subtle',
