...
import {
  TopbarBasicExample,
  TopbarWithContentExample,
} from './Topbar.examples'
...
const docData: DocPageData = {
  ...
  examples: [
    { title: 'With content', content: <TopbarWithContentExample /> },
  ],
  props: [
    { name: 'children', type: `ReactNode`, defaultValue: "-", description: "Header content." }
  ],
  cssHooks: [
    '.mr-topbar', '.mr-topbar__left', '.mr-topbar__center', '.mr-topbar__right',
  ],
  tokens: [
    '--mr-bg-surface', '--mr-border-subtle', '--mr-space-*',
  ],
  a11y: [
    'Banner landmark.',
    'aria-label for branding.',
    'Skip link support.',
  ],
}
