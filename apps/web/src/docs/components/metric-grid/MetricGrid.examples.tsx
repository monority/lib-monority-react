...
export function MetricGridBasicExample() {
  return (
    <MetricGrid
      items={[
        { key: 'revenue', label: 'Revenue', value: '$12,340', trend: '+12%', trendTone: 'success', description: 'Recognized this month' },
        { key: 'users', label: 'Active users', value: '1,234', trend: '+8%', trendTone: 'success', description: 'Last 30 days' },
        { key: 'orders', label: 'Orders', value: '456', trend: '-3%', trendTone: 'danger', description: 'Needs attention' },
        { key: 'conversion', label: 'Conversion', value: '3.2%', trend: '+0.5%', trendTone: 'success', description: 'Checkout funnel' },
      ]}
    />
  )
}
