...
const docData: DocPageData = {
  ...
  cssHooks: [
    '.mr-async-state-notice', '.mr-async-state-notice--loading', '.mr-async-state-notice--error',
    '[data-state]',
  ],
  tokens: [
    '--mr-accent', '--mr-danger', '--mr-bg-accent-soft', '--mr-bg-danger-soft',
    '--mr-text-sm', '--mr-radius-md', '--mr-space-*',
  ],
  a11y: [
