    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <Banner
                tone="info"
                title="Release note"
                description="The command palette now supports scoped search across docs and components."
            />
            <Banner
                tone="success"
            ...
            <Banner
                ...
                description="Rotate staging credentials before Friday to avoid failed previews."
            />
            <Banner
                tone="danger"
                title="Sync paused"
                description="Background imports are blocked until the queue catches up."
            />
        </div>
    )
}
