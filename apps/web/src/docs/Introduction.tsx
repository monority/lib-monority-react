    ...
    <div className="docs-page">
      <header className="docs-hero">
        ...
        <p className="docs-description">
          A modern, accessible React component library for building calm,
          consistent product interfaces with production-ready primitives,
          layouts, feedback surfaces, and overlays.
        </p>
      </header>
  ...
  return <Button>Open workspace</Button>
      ...
      <section className="docs-section">
        ...
        <ul className="docs-list">
          ...
          <li><strong>Typography</strong> - Text, Title, Kbd, PreCode</li>
