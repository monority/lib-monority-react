...
- Contract tests for exports, types, docs alignment, and build health
- Changesets-based release workflow with GitHub Actions CI/CD

### Breaking changes

_None — this is the first release._
