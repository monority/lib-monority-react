...
describe('Textarea', () => {
    ...
    it('renders label, hint, and error via Field wrapper', () => {
        const view = render(
            <Textarea id="msg" label="Message" hint="Optional" error="Invalid" required />
        )
    ...
    it('preserves manual height instead of writing an inline height', () => {
        const view = render(<Textarea defaultValue="First line" />)
